...
def benchmark (iterations):
	def decorator (func):
		...
		def wrapper (*arg, **kwarg):
			...
			print()
			print('Function_name                  | AvvgTime, sec    | Iterations  | Time full iterations, sec  | Time 1 iterations, sec |')
			print('-----------------------------------------------------------------------------------------------------------------------')
			print('{: ^30} | {: ^16.10f} | {: ^12.2f}|  {: ^22.10f} | {: ^25.10f} |'.format(func.__name__, AvvgTime, iterations, max_time, min_time))
